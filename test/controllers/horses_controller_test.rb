...
class HorsesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create horse" do
    assert_difference("Horse.count") do
      post horses_url, params: { horse: { age: @horse.age, name: @horse.name, number_of_legs: @horse.number_of_legs, top_speed: @horse.top_speed } }
    end
  ...
  test "should update horse" do
    patch horse_url(@horse), params: { horse: { age: @horse.age, name: @horse.name, number_of_legs: @horse.number_of_legs, top_speed: @horse.top_speed } }
